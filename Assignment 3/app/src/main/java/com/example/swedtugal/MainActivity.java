...
public class MainActivity extends AppCompatActivity {
    ...
    public void bayesian(View view) {
        Intent intent = new Intent(this, BayesianLocalizationActivity.class);
        startActivity(intent);
    }

    public void particles(View view) {
        Intent intent = new Intent(this, ParticleLocalizationActivity.class);
        startActivity(intent);
    }
}
